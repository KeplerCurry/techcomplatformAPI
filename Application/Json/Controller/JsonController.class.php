...
class JsonController extends Controller {
    ...
    */
    ...
    public function load_apply_for(){
        ...
        $data1 = $userapplyfor1 -> join('tec_techpersonzone as b on b.tpzname = a.tpzname')-> where("a.uid = '$uid' and a.flag = 1") -> field('b.tpzid,a.flag,a.createtime,a.state')-> select();
        $userapplyfor2 = M('userapplyfor');
        $data2 = $userapplyfor2 -> where("uid = '$uid' and flag = 0") ->select();
